              ...
              <View style={styles.exerciseOverview}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    updatingExercise === `${selectedDay}-exercise` && styles.exerciseCompletionButtonDisabled,
                  ]}
                  onPress={handleExerciseToggle}
                  disabled={updatingExercise === `${selectedDay}-exercise`}>
                  {updatingExercise === `${selectedDay}-exercise` ? (
                    <ActivityIndicator size="small" color={currentDay.exercise.isDone ? '#FFFFFF' : '#666666'} />
                  ) : (
                    <>
                      <Ionicons
                      ...
                      <Text style={[
                        ...
                        currentDay.exercise.isDone && styles.exerciseCompletionButtonTextCompleted
                      ]}>
